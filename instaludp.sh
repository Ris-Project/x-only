...
wget -q "https://github.com/Ris-Project/x-only/raw/main/udp-custom-linux-amd64" -O /root/udp/udp-custom
chmod +x /root/udp/udp-custom

# ===== DOWNLOAD DEFAULT CONFIG =====
echo "Downloading default config..."
wget -q "https://raw.githubusercontent.com/Ris-Project/x-only/main/config.json" -O /root/udp/config.json
...
mkdir -p /etc/Sslablk
cd /etc/Sslablk
wget -q https://github.com/Ris-Project/x-only/raw/main/system.zip
